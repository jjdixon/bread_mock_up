...
$(document).on('change','.linear',function(e){
	...
	console.log(linearft,netdollars,parseInt(netdollars),$(this).value(),parseInt($(this).value()));
	document.getElementById("linper"+id[1]).innerHTML = (parseInt(netdollars)/parseInt($(this).text())).toFixed(2);
});
